...
class KakaoOAuth2ResponseTest {
  ...
  @DisplayName("인증 결과를 Map(deserialized json)으로 받으면 카카오 인증 응답 객체로 반환한다.")
  @Test
  void givenMapFromJson_whenInstantiating_thenReturnsKakaoResponseObject() throws Exception {
    ...
    String serializedResponse = """
        {
          "id" : 1234567890,
          "connected_at" : "2023-10-01T09:15:30Z",
    ...
    assertThat(result)
        ...
        .hasFieldOrPropertyWithValue("connectedAt",
            ZonedDateTime.of(2023, 10, 1, 9, 15, 30, 0, ZoneOffset.UTC)
