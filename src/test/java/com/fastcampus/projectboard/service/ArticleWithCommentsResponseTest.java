...
class ArticleWithCommentsResponseTest {
  ...
  @DisplayName("자식 댓글이 없는 게시글 + 댓글 dto를 api 응답으로 변환할 때, 댓글을 시간 내림차순 + ID 오름차순으로 정렬한다.")
  @Test
  void givenArticleWithCommentsDtoWithoutChildComment_whenMapping_thenOrganizesCommentsWithCertainOrder() {
    // Given
  ...
  @Test
  void givenArticleWithCommentsDto_whenMapping_thenOrganizesCommentsWithCertainOrder() {
    // Given
