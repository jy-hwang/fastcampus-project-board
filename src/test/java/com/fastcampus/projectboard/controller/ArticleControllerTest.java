...
class ArticleControllerTest {
  ...
  void givenPagingAndSortingParams_whenSearchingArticlesPage_thenReturnsArticlesPage()
    ...
    given(articleService.searchArticles(null, null, pageable)).willReturn(
        Page.empty());
  ...
  @Test
  public void givenNothing_whenRequestingArticlesHashtagSearchView_thenReturnsArticlesHashtagSearchView()
      throws Exception {
    //given
